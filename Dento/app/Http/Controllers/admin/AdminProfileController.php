...
class AdminProfileController extends Controller
{
    ...
    public function update(Request $request)
    {
        ...
        if($validator->passes()){
            ...
            $user->update();
            return redirect()->route('admin.profile')->with('success','You have registered successfully :)');
        }else{
    ...
    public function updatePassword(Request $request)
    {
        ...
        if ($validator->passes()) {
            ...
            if (Hash::check($request->currentPassword, $user->password)) {
                ...
                return redirect()->route('admin.profile')->withErrors(['currentPassword' => 'The current password is incorrect'])->withInput();
            }
        } else {
            return redirect()->route('admin.profile')->withErrors($validator)->withInput();
        }
