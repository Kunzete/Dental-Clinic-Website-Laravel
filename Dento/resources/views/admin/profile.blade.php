            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        @else
                            <img src="{{ asset('images/profile/' . Auth::guard('admin')->user()->image) }}" alt="Profile"
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ Auth::guard('admin')->user()->role }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">number</div>
                                    <div class="col-lg-9 col-md-8">{{ Auth::guard('admin')->user()->number }}</div>
                                </div>
                            ...
                            <div class="tab-pane fade profilePicture pt-3" id="profilePicture">
                                ...
                                <form method="POST" action="{{ route('admin.pfp') }}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <form action="{{ route('admin.deletePFP') }}" method="POST">
                                    @csrf
