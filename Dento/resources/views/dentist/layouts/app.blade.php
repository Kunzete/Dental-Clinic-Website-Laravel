...
<body>
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown pe-3">
                    ...
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#"
                        ...
                        @else
                            <img src="{{ asset('images/profile/' . Auth::guard('doctor')->user()->image) }}"
                                alt="Profile" class="rounded-circle">
                        @endif
                        <span
                            class="d-none d-md-block dropdown-toggle ps-2">{{ Auth::guard('doctor')->user()->name }}</span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="{{ route('dentist.profile') }}">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="{{ route('dentist.logout') }}">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="{{ route('dentist.profile') }}">
