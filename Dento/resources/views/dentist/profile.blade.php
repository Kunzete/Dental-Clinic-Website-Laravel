            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        @else
                            <img src="{{ asset('images/profile/' . Auth::guard('doctor')->user()->image) }}" alt="Profile"
                                class="rounded-circle">
                        @endif
                        <h2>{{ Auth::guard('doctor')->user()->name }}</h2>
                        <h3>{{ Auth::guard('doctor')->user()->role }}</h3>
                    </div>
                </div>
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-9 col-md-8">{{ Auth::guard('doctor')->user()->name }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Role</div>
                                    <div class="col-lg-9 col-md-8">{{ Auth::guard('doctor')->user()->role }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">number</div>
                                    <div class="col-lg-9 col-md-8">{{ Auth::guard('doctor')->user()->number }}</div>
                                </div>

                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label">Email</div>
                                    <div class="col-lg-9 col-md-8">{{ Auth::guard('doctor')->user()->email }}</div>
                                </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <input name="number" type="number"
                                                ...
                                                value="{{ Auth::guard('doctor')->user()->number }}">
                                            @error('number')
                                                <p class="invalid-feedback">{{ $message }}</p>
                                            @enderror
                                        </div>
                            ...
                            <div class="tab-pane fade profilePicture pt-3" id="profilePicture">
                                ...
                                <form method="POST" action="{{ route('dentist.pfp') }}" enctype="multipart/form-data">
                                    @csrf
                                ...
                                <form action="{{ route('dentist.deletePFP') }}" method="POST">
                                    @csrf
